...
<div class="max-w-4xl mx-auto bg-white p-8 shadow-xl">
    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="name" id="name" placeholder="Masukkan nama produk" value="{{ old('name') }}" class="w-full p-4 mt-2 border border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none">
            @error('name')
        ...
        <div class="mb-6">
            ...
            <textarea name="description" id="editor" placeholder="Masukkan deskripsi produk">{{ old('description') }}</textarea>
            <script>    
                ClassicEditor
        ...
        <div class="mb-6">
            ...
            <input type="number" name="price" id="price" placeholder="Masukkan harga produk" value="{{ old('price') }}" class="w-full p-4 mt-2 border border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none">
            @error('price')
                <span class="text-red-500 text-sm">{{ $message }}</span>
            @enderror
        </div>
